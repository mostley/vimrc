nnoremap <silent> <C-p> :lua require('config.telescope').project_files()<CR>
nnoremap <silent> <leader>fg :Telescope find_files hidden=true no_ignore=true<cr>
...
nnoremap <silent> <leader>fe :Telescope emoji<CR>
