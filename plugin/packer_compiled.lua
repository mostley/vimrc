...
_G.packer_plugins = {
  ...
  ["touble.nvim"] = {
    ...
    loaded = true,
    path = "/Users/svenhecht/.local/share/nvim/site/pack/packer/start/touble.nvim"
  },
  ["vim-abolish"] = {
    loaded = true,
...
-- Config for: touble.nvim
time([[Config for touble.nvim]], true)
try_loadstring("\27LJ\2\n9\0\0\3\0\3\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0004\2\0\0B\0\2\1K\0\1\0\nsetup\ftrouble\frequire\0", "config", "touble.nvim")
time([[Config for touble.nvim]], false)
