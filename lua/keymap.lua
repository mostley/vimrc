...
local keymappings = {
  ...
  normal_mode = {
    ...
    ["<leader>so"] = ":Telescope lsp_document_symbols<CR>",
    ["<leader>tqf"] = ":Telescope quickfix<CR>",
    ["<Leader>gs"] = ":Git<CR>",
    ["<Leader>gps"] = ":Git push<CR>",
    ["<Leader>gpl"] = ":Git pull<CR>",
    ["<Leader>gpu"] = ":Git push -u origin<CR>",
    ["<Leader>gds"] = "<cmd>Gvdiffsplit<CR>",
    ["<Leader>ga"] = "Git fetch --all<CR>",
    ["<Leader>grc"] = "Git rebase --continue<CR>",
    ["<Leader>grum"] = "Git rebase upstream/main<CR>",
    ["<Leader>grom"] = "Git rebase origin/main<CR>",
    ...
    ["<leader>g-"] = ":Silent Git stash<CR>",
    ["<leader>g+"] = ":Silent Git stash pop<CR>",
