...
_G.packer_plugins = {
  ...
  ["neodev.nvim"] = {
    loaded = true,
    path = "/Users/svenhecht/.local/share/nvim/site/pack/packer/start/neodev.nvim",
  ...
  neotest = {
    after = { "neotest-python", "neotest-vitest", "neotest-vim-test", "neotest-go", "neotest-plenary", "neotest-jest" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/svenhecht/.local/share/nvim/site/pack/packer/opt/neotest",
    url = "https://github.com/nvim-neotest/neotest",
    wants = { "plenary.nvim", "nvim-treesitter", "neotest-python", "neotest-go", "neotest-plenary", "neotest-jest", "neotest-vitest", "neotest-vim-test" }
  },
  ["neotest-go"] = {
    load_after = {
      neotest = true
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/svenhecht/.local/share/nvim/site/pack/packer/opt/neotest-go",
  ...
  ["neotest-jest"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/svenhecht/.local/share/nvim/site/pack/packer/opt/neotest-jest",
  ...
  ["neotest-plenary"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/svenhecht/.local/share/nvim/site/pack/packer/opt/neotest-plenary",
  ...
  ["neotest-python"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/svenhecht/.local/share/nvim/site/pack/packer/opt/neotest-python",
  ...
  ["neotest-vim-test"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/svenhecht/.local/share/nvim/site/pack/packer/opt/neotest-vim-test",
  ...
  ["neotest-vitest"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/svenhecht/.local/share/nvim/site/pack/packer/opt/neotest-vitest",
...
pcall(vim.api.nvim_create_user_command, 'TodoTrouble', function(cmdargs)
        ...
        {nargs = '*', range = true, bang = true, complete = function()
          require('packer.load')({'todo-comments.nvim'}, { cmd = 'TodoTrouble' }, _G.packer_plugins)
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'trouble.nvim', 'package-info.nvim', 'vim-markdown'}, { event = "VimEnter *" }, _G.packer_plugins)]]
